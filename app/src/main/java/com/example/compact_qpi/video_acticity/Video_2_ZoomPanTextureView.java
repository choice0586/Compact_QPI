...
public class Video_2_ZoomPanTextureView extends TextureView {
    ...
    // ZoomPanTextureView
    //******************************************************************************
    public Video_2_ZoomPanTextureView(Context context)
    {
        super(context);
        initialize(context);
    }
    ...
    // ZoomPanTextureView
    //******************************************************************************
    public Video_2_ZoomPanTextureView(Context context, final AttributeSet attrs)
    {
        super(context, attrs);
        initialize(context);
    }
    ...
    // ZoomPanTextureView
    //******************************************************************************
    public Video_2_ZoomPanTextureView(Context context, AttributeSet attrs, int defStyle)
    {
