...
public class Video_6_SpsParser {
    // local constants
    private final static String TAG = "SpsParser";

    // instance variables
    private Video_7_SpsReader reader;
    public int width, height;
    public float fps;
    public int num_units_in_tick = 0;
    public int time_scale = 0;

    public Video_6_SpsParser(byte[] nal, int len)
    {
        // 여기서 SpsReader Class 쓰네
        reader = new Video_7_SpsReader(nal, len);
